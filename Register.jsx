...
export default class Register extends React.Component {
    ...
    register() {
        ...
        var registerModel = {
            ...
            mobileNumber: this.state.mobileNumber.toString(),
        ...
        $.ajax({
            url: 'https://talentservicesidentityharish.azurewebsites.net/authentication/authentication/signup',
            type: 'POST',
        ...
        return (
            <form className={`ui large form ${this.isLoadingChange()}`}>
                ...
                <SingleInput
                    ...
                    content={this.state.countryCode}
                    controlFunc={this.handleUserInput}
                />
                <SingleInput
                    title="Mobile number"
                    ...
                    errorMessage="Please enter your mobile numbeer"
